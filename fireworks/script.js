...
const helpContent = {
  shellType: {
    header: "Tipe Kembang Api",
    body: "Pilih jenis kembang api yang ingin diledakkan. Pilih 'Random' (Acak) untuk pengalaman yang lebih variatif!",
  },
  shellSize: {
    header: "Ukuran Kembang Api",
    body: "Semakin besar kembang api, semakin luas ledakannya. Namun, ukuran yang besar membutuhkan performa lebih tinggi dan mungkin membuat perangkat terasa lambat (lag).",
  },
  quality: {
    header: "Kualitas Grafis",
    body: "Jika animasi terasa patah-patah, coba turunkan kualitasnya. Kualitas tinggi menampilkan lebih banyak percikan api, tetapi bisa memberatkan perangkat.",
  },
  skyLighting: {
    header: "Pencahayaan Langit",
    body: "Saat kembang api meledak, langit akan ikut terang. Jika layar terasa terlalu silau, Anda bisa mengaturnya ke 'Gelap' atau mematikannya.",
  },
  scaleFactor: {
    header: "Skala (Zoom)",
    body: "Mengatur jarak pandang ke kembang api. Untuk kembang api besar, disarankan memperkecil skala ini, terutama jika menggunakan HP atau tablet.",
  },
  wordShell: {
    header: "Kembang Api Teks",
    body: "Jika diaktifkan, kembang api akan membentuk tulisan saat meledak. Contoh: 'Selamat Tahun Baru', dan lainnya.",
  },
  autoLaunch: {
    header: "Otomatis Luncurkan",
    body: "Duduk santai dan nikmati pertunjukannya. Jika dimatikan, Anda harus mengetuk layar secara manual untuk meluncurkan kembang api.",
  },
  finaleMode: {
    header: "Mode Finale (Ramai)",
    body: "Meluncurkan banyak kembang api sekaligus secara otomatis (memerlukan fitur 'Otomatis Luncurkan' aktif).",
  },
  hideControls: {
    header: "Sembunyikan Tombol",
    body: "Menyembunyikan tombol di bagian atas layar. Cocok untuk screenshot atau tampilan bersih. Anda tetap bisa membuka pengaturan lewat pojok kanan atas meski tombol tersembunyi.",
  },
  fullscreen: {
    header: "Layar Penuh",
    body: "Mengaktifkan tampilan layar penuh.",
  },
  longExposure: {
    header: "Long Exposure (Jejak)",
    body: "Membuat percikan api tidak langsung hilang, meninggalkan jejak cahaya yang artistik.",
  },
};
...
function init() {
  ...
  setOptionsForSelect(appNodes.skyLighting, [
    { label: "Mati", value: SKY_LIGHT_NONE },
    { label: "Redup", value: SKY_LIGHT_DIM },
    { label: "Terang", value: SKY_LIGHT_NORMAL },
  ]);
